 ...
 */
	...
	elseif (!$Opauth->validate(sha1(print_r($response['auth'], true)), $response['timestamp'], $response['signature'], $reason)){
		 ...
		 */
		 ...
		 $_SESSION['info'] = $response['auth']['info'];
		 $_SESSION['provider'] = $response['auth']['provider'];
		 
		header('Location: '.'http://www.paulius.nl/4ME102FA/JuxtaLearn/index.php', true, 301); 
		die();
		//include "./code/authenticated.php";
